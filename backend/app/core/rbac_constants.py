...
SIDEBAR_MENU_CATALOG = [
    ...
    },
    {
        ...
        "module": "accounts",
        "children": [
            {"label": "Receivables", "path": "/finance/accounts-receivable", "module": "accounts"},
            {"label": "Payables", "path": "/accounts/accounts-payable", "module": "accounts"},
            {"label": "Payments", "path": "/finance/payment-tracking", "module": "accounts"},
            {"label": "Invoices", "path": "/sales/invoices", "module": "accounts"},
            {"label": "Bills", "path": "/procurement/vendor-bills", "module": "accounts"},
            {"label": "Cash & Bank", "path": "/accounts/ledger", "module": "accounts"},
            ...
            {"label": "Reports", "path": "/accounts/reports", "module": "accounts"},
            {"label": "Bank Reconciliation", "path": "/accounts/bank-reconciliation", "module": "accounts"},
            {"label": "Settings", "path": "/accounts/settings", "module": "accounts"},
    ...
    },
    {
        ...
        "module": "hr",
        "children": [
            {"label": "Dashboard", "path": "/hr", "module": "hr"},
            {"label": "Attendance", "path": "/hr/attendance", "module": "hr"},
            {"label": "Leave Tracker", "path": "/hr/leave", "module": "hr"},
            {"label": "Shift Management", "path": "/hr/shifts", "module": "hr"},
            {"label": "Employee Management", "path": "/hr/employees", "module": "hr"},
            {"label": "Expense Management", "path": "/hr/expenses", "module": "hr"},
            ...
            {"label": "MIS Reports", "path": "/hr/reports/attendance", "module": "hr"},
            {"label": "Announcements", "path": "/hr/announcements", "module": "hr"},
            {"label": "Configuration", "path": "/hr/settings", "module": "hr"},
        ],
    },
    {
        "key": "admin",
