...
export const OperatorJobsPage = lazy(() => import("../pages/production/OperatorJobsPage"));
export const LegacyJobCardRedirect = lazy(() => import("../pages/manufacturing/LegacyJobCardRedirect"));
...
export const Shipping = lazy(() => import("../pages/sales/Shipping"));
...
export const HRBulkUploadEmployees = lazy(() => import("../pages/hr/BulkUploadEmployees"));
export const HROffboarded = lazy(() => import("../pages/hr/Offboarded"));
export const HRExpenseOverview = lazy(() => import("../pages/hr/ExpenseOverview"));
export const HRMyExpenses = lazy(() => import("../pages/hr/MyExpenses"));
export const HRExpenseApprovals = lazy(() => import("../pages/hr/ExpenseApprovals"));
export const HRAttendance = lazy(() => import("../pages/hr/Attendance"));
export const HRAttendanceApproval = lazy(() => import("../pages/hr/AttendanceApproval"));
export const HROvertime = lazy(() => import("../pages/hr/Overtime"));
export const HRAttendanceAdjustedLeave = lazy(() => import("../pages/hr/AttendanceAdjustedLeave"));
export const HRAttendanceSettings = lazy(() => import("../pages/hr/AttendanceSettings"));
export const HRLeave = lazy(() => import("../pages/hr/Leave"));
...
export const HRCreateLeavePlan = lazy(() => import("../pages/hr/CreateLeavePlan"));
export const HRCreateLeave = lazy(() => import("../pages/hr/CreateLeave"));
export const HRPayroll = lazy(() => import("../pages/hr/Payroll"));
export const HRCreatePayroll = lazy(() => import("../pages/hr/CreatePayroll"));
export const HRPerformance = lazy(() => import("../pages/hr/Performance"));
export const HRCreatePerformance = lazy(() => import("../pages/hr/CreatePerformance"));
export const HRTraining = lazy(() => import("../pages/hr/Training"));
export const HRRecruitment = lazy(() => import("../pages/hr/Preboarding"));
export const HRAddCandidate = lazy(() => import("../pages/hr/AddCandidate"));
export const HRShifts = lazy(() => import("../pages/hr/Shifts"));
export const HRMonthlyShifts = lazy(() => import("../pages/hr/MonthlyShifts"));
export const HRWeekOff = lazy(() => import("../pages/hr/WeekOff"));
export const HRCreateShift = lazy(() => import("../pages/hr/CreateShift"));
export const HRAssets = lazy(() => import("../pages/hr/CompanyAssets"));
export const HRCreateAsset = lazy(() => import("../pages/hr/AllocateAssets"));
export const HRMappedAssets = lazy(() => import("../pages/hr/MappedAssets"));
export const HRIncidents = lazy(() => import("../pages/hr/IncidentReports"));
export const HRCreateIncident = lazy(() => import("../pages/hr/CreateIncident"));
export const HRDocuments = lazy(() => import("../pages/hr/HRDocuments"));
export const HRSettings = lazy(() => import("../pages/hr/OrganizationSetup"));
export const HRRolesPermissions = lazy(() => import("../pages/hr/HRRolesPermissions"));
export const HRSiteVisit = lazy(() => import("../pages/hr/SiteVisit"));
export const HRSalaryComponents = lazy(() => import("../pages/hr/SalaryComponents"));
export const HRStatutoryComponents = lazy(() => import("../pages/hr/StatutoryComponents"));
export const HRSalaryBreakupList = lazy(() => import("../pages/hr/SalaryBreakupList"));
...
export const HRPfReport = lazy(() => import("../pages/hr/PfReport"));
