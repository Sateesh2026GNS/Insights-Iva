/**
 * Branded Loading Screen with full pure black backdrop and centered animated multi-ring spinner.
 * Used for initial app load, reloads, and route transitions across the entire project.
 */
